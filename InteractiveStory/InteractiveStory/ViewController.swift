...
//  InteractiveStory
//
//  Created by Matthew Foster on 7/16/18.
//  Copyright © 2018 fostermatt. All rights reserved.
//
	...
	override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
		if segue.identifier == "startAdventure" {
			...
			do {
				...
				let alertController = UIAlertController(title: "Name Not Provided", message: "Provide a name to star the story", preferredStyle: .alert)
